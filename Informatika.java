...
class Informatika {
	...
	void pendaftarantif (){
		...
		while (pilih==0)
		{
			...
			System.out.println("=================================");
			System.out.println("Nomor Induk Mahasiswa Anda adalah : 15 111 300");
			System.out.println();
			System.out.println();
